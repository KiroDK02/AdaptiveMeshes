...
{
    extension(IPlotControl plotControl)
    {
            ...
            bool showDofs = false)
        {
            ...
            foreach (var element in mesh.Elements)
            {
                ...
                var polygon = plotControl.Plot.Add.Polygon(
            ...
            foreach (var element in mesh.Elements)
            {
                ...
                var line = plotControl.Plot.Add.Line(vertices[0].X, vertices[0].Y, vertices[1].X, vertices[1].Y);
        ...
        public void DrawDofs(IFiniteElementMesh mesh)
        {
            foreach (var element in mesh.Elements)
            {
                if (element.VertexNumbers.Length == 2)
                ...
                {
                    var text = plotControl.Plot.Add.Text(label, position.X, position.Y);
