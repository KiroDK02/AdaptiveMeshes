...
public class FileManager
{
    ...
    public IFiniteElementMesh ReadMeshFromTelma(string path)
    {
        ...
        var countVertices = int.Parse(reader.ReadLine()!);
        ...
        var countElements = int.Parse(reader.ReadLine()!);
        ...
        var countMaterial = int.Parse(reader.ReadLine()!);
        ...
        var countBoundMaterials = int.Parse(reader.ReadLine()!);
        ...
        var elements = new IFiniteElement[listElems.Count];
    ...
    public void LoadMyMeshFormat(string path, IFiniteElementMesh mesh)
    {
        ...
        foreach (var element in mesh.Elements)
        {
            if (element.VertexNumbers.Length == 3)
                writer.WriteLine(
                    $"Triangle {element.VertexNumbers[0]} {element.VertexNumbers[1]} {element.VertexNumbers[2]} {element.Material}");
            else
