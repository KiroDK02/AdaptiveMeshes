...
public class Material : IMaterial
{
    ...
    public Material(bool isVolume, bool is1, bool is2, Func<Vector2D, double> lambda, Func<Vector2D, double> sigma,
        Func<Vector2D, double, double> ug, Func<Vector2D, double, double> thetta, Func<Vector2D, double, double> f)
    {
        IsVolume = isVolume;
        Is1 = is1;
        Is2 = is2;
