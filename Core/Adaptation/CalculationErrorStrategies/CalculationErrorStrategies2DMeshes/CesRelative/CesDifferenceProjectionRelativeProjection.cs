...
public class CesDifferenceProjectionRelativeProjection : CesDifferenceProjectionFlowOnEdge
{
    public CesDifferenceProjectionRelativeProjection(IDictionary<string, IMaterial> materials) 
        : base(materials) { }
