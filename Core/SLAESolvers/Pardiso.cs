...
public class Pardiso<T> : IDisposable
    where T : unmanaged
{
    ...
    private void ThrowIfError(int error)
    {
        switch (error)
        {
            ...
            case -4:
                throw new Exception(
                    "Pardiso error: zero pivot, numerical factorization or iterative refinement problem");
            case -3:
                throw new Exception("Pardiso error: reordering problem");
            case -2:
                throw new Exception(string.Format("Pardiso error: not enough memory. Need {0} MB",
                    this.MemorySize / 1024L / 1024L));
            case -1:
    ...
    {
        int error;
        Pardiso.pardiso((Span<IntPtr>)this._pt, this._maxfct, this._mnum, this._type, 11, this._n, this._matrix.a,
            this._matrix.ia, this._matrix.ja, (Span<int>)(int[])null!, this._nrhs, (Span<int>)this._iparm, this._msglvl,
            (ReadOnlySpan<T>)(T[])null!, (Span<T>)(T[])null!, out error);
    ...
    {
        int error;
        Pardiso.pardiso((Span<IntPtr>)this._pt, this._maxfct, this._mnum, this._type, 22, this._n, this._matrix.a,
            this._matrix.ia, this._matrix.ja, (Span<int>)(int[])null!, this._nrhs, (Span<int>)this._iparm, this._msglvl,
            (ReadOnlySpan<T>)(T[])null!, (Span<T>)(T[])null!, out error);
        this.ThrowIfError(error);
    }
    ...
    {
        int error;
        Pardiso.pardiso((Span<IntPtr>)this._pt, this._maxfct, this._mnum, this._type, 33, this._n, this._matrix.a,
            this._matrix.ia, this._matrix.ja, (Span<int>)(int[])null!, this._nrhs, (Span<int>)this._iparm, this._msglvl,
            b, x, out error);
        this.ThrowIfError(error);
    }
    ...
    public void SolveT(ReadOnlySpan<T> b, Span<T> x)
    {
        ...
        this._iparm[11] = 2;
        int error;
        Pardiso.pardiso((Span<IntPtr>)this._pt, this._maxfct, this._mnum, this._type, phase, this._n, this._matrix.a,
            this._matrix.ia, this._matrix.ja, (Span<int>)(int[])null!, this._nrhs, (Span<int>)this._iparm, this._msglvl,
            b, x, out error);
        this._iparm[11] = 0;
        this.ThrowIfError(error);
    ...
    protected virtual void Dispose(bool disposing)
    {
        if (this._disposed)
            return;
        Pardiso.pardiso((Span<IntPtr>)this._pt, this._maxfct, this._mnum, this._type, -1, this._n, this._matrix.a,
            this._matrix.ia, this._matrix.ja, (Span<int>)(int[])null!, this._nrhs, (Span<int>)this._iparm, this._msglvl,
            (ReadOnlySpan<T>)(T[])null!, (Span<T>)(T[])null!, out int _);
        this._disposed = true;
    }
}